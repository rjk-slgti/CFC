...
describe('DataQualityService', () => {
  ...
  it('should return high score for perfect data quality', () => {
    ...
    assert.ok(result.totalScore >= 90, `Expected score >= 90, got ${result.totalScore}`);
  ...
  it('should return lower score for older factors', () => {
    ...
    // 2025 - 2022 = 3 years, which maps to <= 3 years -> score 10
    assert.ok(recencyFactor.score <= 10, `Expected recency score <= 10, got ${recencyFactor.score}`);
  });
